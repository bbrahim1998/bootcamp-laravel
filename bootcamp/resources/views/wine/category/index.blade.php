        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                                     ...
                                     <div class="flex flex-col p-4 leading-normal">
                                        ...
                                        <div class="absolute bottom-0 right-0 p-4 flex justify-between">
                                            ...
                                            <form action="{{ route('categories.destroy', $category)}} " method="POST">
                                                ...
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="bg-red-500 hover:bg-red-700 text-white fond-bold p-1 rounded w-full md:w-auto ms-2">
                                                    Eliminar
                                                </button>
                                            </form>
                                        </div>
                    ...
                    @else
                        <p class="mt-4 bg-red-100 border border-red-400 text-red-700 px-4 rounded relative" role="alert">
                            <strong class="font-bold">¡Lo siento!</strong>
                            <span class="block sm:inline">No hay categorias de vinos creadas</span>
                        </p>
                    @endif
                </div>
            </div>
